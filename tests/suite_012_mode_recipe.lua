...
return {
    ...
    tests = {
        [s .. "01"] = {
            ...
            expectations = {
                { 4, "Usage: pods recipe [OPTIONS] NAME ACTION" },
            },
        },
        [s .. "02"] = {
        ...
        [s .. "03"] = {
            ...
            config = "config_005_recipes",
            parameters = { "recipe", "unknown", "print" },
            expectations = {
        ...
        [s .. "05"] = {
            ...
            config = "config_005_recipes",
            parameters = { "recipe", "recipe_002_no_pod", "unknown" },
            expectations = {
        ...
        [s .. "06"] = {
            ...
            expectations = {
                { 4, "ERROR: No name or action given. (name: 'recipe_002_no_pod', action: 'nil')" },
            },
        },
    }
}
